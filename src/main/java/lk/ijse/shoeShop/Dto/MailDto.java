...
public class MailDto implements Runnable{
    private String msg;
    private String to;
    ...
    public void outMail() throws MessagingException {
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("javatextmail@gmail.com", "xyjusxlufnvuijsz");  // have to change some settings in SMTP
            }
        });
